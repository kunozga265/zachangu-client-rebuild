<template>
    <jet-authentication-card class="min-h-screen">
        <template #logo>
            <jet-authentication-card-logo />
        </template>

        <template #heading>
            <p class="text-xl font-bold text-center">Create an account</p>
            <p class="text-center">A few steps to access quick and secure loans</p>
        </template>
