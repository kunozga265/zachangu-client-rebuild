        ...
        <div>
                        ...
                        <div class="p-12 sm:px-20 bg-white border-b border-gray-200">
                            ...
                            <div class="mt-6">
                                ...
                                <div class="mt-4 mx-2 p-6  border-l-2 border-gray-200">
                                    ...
                                    <span>I accept the terms in the <span class="cursor-pointer underline text-gray-600 hover:text-gray-900" @click="termsAndConditionsGuarantorDialog=true">License Agreement</span></span>
                                    ...
                                    <jet-dialog-modal :show="termsAndConditionsGuarantorDialog" @close="closeGuarantorModal">
                                        ...
                                        <template #content>
                                            <div v-html="$page.props.termsAndConditionsGuarantor"></div>
                                        </template>
            ...
            <div class="fixed bottom-0 h-20 p-6 bg-white shadow w-full flex items-center">
                <div v-if="validation" class="w-full flex items-center justify-center">
                    ...
                    <jet-button class="ml-4" @click.native="guarantee">
                        Guarantee Loan
                    </jet-button>
    ...
    computed:{
        ...
        validation:function () {
            if(!this.termsAndConditionsCheck){
                ...
                this.errorSection='Guarantor License Agreement';
                return false;
            }else
                return true
        },
